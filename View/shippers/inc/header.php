                    ...
                    <nav id="mainmenu_wrapper">
                        <ul id="mainmenu" class="nav sf-menu">
                         <?php if(isset($_SESSION['userId'])){?>
                           <li>
                              <a href="index.html"><img src="<?=BASEURL;?>assets/img/profileIcon.png" class="profileIcon"></i> <?=ucwords($_SESSION['fname']);?> <?=substr($_SESSION['lname'],0,1);?>.</a>
                           </li>
                         <?php } ?>   
